...
MMD ワークフロー向けの Blender アドオンです。MMD 口形生成、ランダムまばたき、シェイプキー補助、MikuMikuDance スタイルのキャラクター向け Blender ワークフローツールを含みます。
...
> 現在の状況
>
> `v0.5.0` はまもなく公開予定で、大規模な更新を含みます。
>
> すぐに比較的安定した版が必要な場合は、まず `v0.3.2` を利用してください。
