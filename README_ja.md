...
| 機能 | 説明 | 対応バージョン |
|---|---|---|
| **MMD リップシンク** | 音声のフォルマント分析により口形状キー（あいうえおん）を生成 | v0.3 |
| **ランダムまばたき** | ガウス分布に基づく自然なまばたき。半まばたき・二重まばたき対応 | v0.5 |
| **レンダリング最適化** | ワンクリックで適応的ライティング、PBR/NPR マテリアル強化、ワールド＆コンポジターを設定 | v0.5 |
| **カメラプリセット** | MMD シーン向けの解像度、アスペクト比、画面方向のクイック設定 | v0.5 |
| **タイムライン音声源** | ビデオシーケンスエディターの音声ストリップをリップシンク入力として直接使用 | v0.5 |
| **シェイプキー補助** | シェイプキーを MMD 標準名称にコピー・リネーム | v0.3 |
